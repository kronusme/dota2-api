...
class league_mapper {
    ...
    public function load() {
        ...
        foreach($league_live_matches->game as $game) {
            ...
            $a_game['radiant_team_id'] = $a_game['radiant_team']['team_id'];
            $a_game['radiant_name'] = $a_game['radiant_team']['team_name'];
            $a_game['radiant_logo'] = $a_game['radiant_team']['team_logo'];
            $a_game['radiant_team_complete'] = ($a_game['radiant_team']['complete'] == 'false')? 0 : 1;
            $a_game['dire_team_id'] = $a_game['dire_team']['team_id'];
            $a_game['dire_name'] = $a_game['dire_team']['team_name'];
            $a_game['dire_logo'] = $a_game['dire_team']['team_logo'];
